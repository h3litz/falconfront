export default {
  ...
  'app.analysis.domain-count': '域名总数',
  'app.analysis.ip-count': 'IP总数',
  'app.analysis.web-count': 'Web总数',
  'app.analysis.port-count': '端口总数',
  'app.analysis.vuln-count': '漏洞总数',
  'app.analysis.vulnValidRate': '漏洞准确率',
  'app.analysis.vuln-valid-count': '有效',
  'app.analysis.day-new-increased-domain': '今日新增域名',
  'app.analysis.day-new-increased-ip': '今日新增IP',
  'app.analysis.day-new-increased-port': '今日新增端口',
  'app.analysis.day-new-increased-web': '今日新增web',
  'app.analysis.vuln-month-count': '月漏洞趋势',
