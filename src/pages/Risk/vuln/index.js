...
class Vuln extends PureComponent {
          ...
          render: (record) => (
            <Dropdown overlay={
              <Menu onClick={this.showDeleteModal} selectedKeys={[]}>
                ...
                <Menu.Item key="fixed">修复</Menu.Item>
    ...
    render() {
        ...
        const {  selectedRows, deleteVisible, bulkDeleteVisible , bulkDeleteDone, current, deleteDone = {} } = this.state;
                ...
                <StandardTable
                  ...
                  expandedRowRender={record => 
                    <div style={{ margin: 0 ,padding: 0}}>
                      ...
                      <Divider />
                      <span style={{ margin: 0 }}>漏洞发现时间: {record.created} <Divider type="vertical" /> 漏洞更新时间: {record.modified}</span>
                    </div>}
                />
              </div>
            </Card>
